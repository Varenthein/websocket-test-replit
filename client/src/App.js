  ...
  <div className="App">
    ...
    <section className="tasks-section" id="tasks-section">
      ...
      <form id="add-task-form" onSubmit={(e)=> submitForm(e)}>
        <input value={taskName} onChange={(e) => setTaskName(e.target.value)} className="text-input"  autocomplete="off" type="text" placeholder="Type your description" id="task-name" />
